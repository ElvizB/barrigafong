                ...
                <div class="bg-title-service-op">
                    ...
                    <div class="center-grid">
                        <div class="grid-title-service">
                            <h1>Hernioplastía inguinal laparoscópica</h1>
                            <h1><b>HERNIOLAP</b></h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-cuerpo-service">
                ...
                <div class="grid-description-extra">
                    <div class="content-description-extra">
                        ...
                        <p>
                            Consiste en la corrección del defecto herniario más la colocación de la malla de
                            polipropileno vía laparoscópica.
                        </p>

                    </div>
                    <div class="img-service-extra">
                        <img loading="lazy" src="<?php echo RUTA_IMG?>servicios/d4.png" draggable="false"
                            class="img-fluid" />
                    </div>
                </div>
