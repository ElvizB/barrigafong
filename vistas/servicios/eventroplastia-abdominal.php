                ...
                <div class="bg-title-service">
                    ...
                    <div class="center-grid">
                        <div class="grid-title-service">
                            <h1>Eventroplastía abdominal</h1>
                            <!-- <h1><b>HERNIOLAP</b></h1> -->
                        </div>
                    </div>
                </div>
            ...
            <div class="box-cuerpo-service">
                ...
                <div class="grid-description-extra">
                    <div class="content-description-extra">
                        ...
                        <p>
                            Es la reparación de la pared abdominal más colocación de malla de polipropileno. La
                            eventración se da a través de la cicatriz de la cirugía previa.
                        </p>

                    </div>
                    <div class="img-service-extra">
                        <img loading="lazy" src="<?php echo RUTA_IMG?>servicios/d5.png" draggable="false"
                            class="img-fluid" />
                    </div>
                </div>
