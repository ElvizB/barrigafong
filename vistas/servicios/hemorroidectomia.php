...
<section class="servicio">
    <div class="bg-servicio">
        <img loading="lazy" src="<?php echo RUTA_IMG?>servicios/bg.png" draggable="false" height="762"
            class="img-bg-service" />
    ...
    <div class="bg-cuerpo-servicio">
        ...
        <div class="center-grid">
            <div class="box-cuerpo-service">
                <div class="img-flecha-cuerpo">
                    <img loading="lazy" src="<?php echo RUTA_IMG?>servicios/flecha.png" draggable="false" />
                </div>
                <div class="grid-info-service">
                ...
                <div class="grid-descripcion-service">
                    <div class="content-grid-descripcion">
                        <ul class="list-descripcion-service">
                            <li>Consulta de valoración</li>
                            <li>Estudio preoperatorio</li>
                            <li>Gastos de la operación y <br> honorarios médicos</li>
                        </ul>
                    </div>
                    <div class="content-grid-descripcion">
                        <ul class="list-descripcion-service">
                            <li>Estancia en el hospital</li>
                            <li>Revisión postquirúrgica</li>
                            <li>Servicio de traslado i/v* <br>*Consultar disponibilidad de zona</li>
                        </ul>
                    </div>
                </div>

                <div class="grid-description-extra">
                    <div class="content-description-extra">
                        <h2><b>Descripción</b></h2>
                        <p>
                            Procedimiento que se realiza para extirpar las hemorroides producidas por la inflamación y/o
                            estiramiento de un conjunto de tejidos y venas alrededor de la cavidad anal.
                        </p>

                    </div>
                    <div class="img-service-extra">
                        <img loading="lazy" src="<?php echo RUTA_IMG?>servicios/d8.png" draggable="false"
                            class="img-fluid" />
                    </div>
                </div>
