                ...
                <div class="bg-title-service">
                    ...
                    <div class="center-grid">
                        <div class="grid-title-service">
                            <h1>Apendicectomía laparoscópica </h1>
                            <h1><b>APENDILAP</b></h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-cuerpo-service">
                ...
                <div class="grid-description-extra">
                    <div class="content-description-extra">
                        ...
                        <p>
                            Es la extirpación del apéndice cecal. Se realizan 2 pequeñas incisiones en el abdomen
                            introduciéndose un endoscopio pequeño y pinzas especiales.
                        </p>

                    </div>
                    <div class="img-service-extra">
                        <img loading="lazy" src="<?php echo RUTA_IMG?>servicios/d2.png" draggable="false"
                            class="img-fluid" />
                    </div>
                </div>
