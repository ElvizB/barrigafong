<!-- Footer -->
<footer class="footer">
    <div class="grid-footer wow fadeIn" data-wow-delay="0.4s">
    ...
    <div class="floating-wp z-depth-1">
        <div class="grid-floatig-wp">
            <a class="" href="https://api.whatsapp.com/send?phone=51949703230&amp;text=hola" target="_blank">
                <img src="<?php echo RUTA_IMG?>footer/wp.png" draggable="false"
